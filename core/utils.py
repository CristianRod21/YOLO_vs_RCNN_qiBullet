...
def draw_bbox(image, bboxes, object_to_find, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True):
    """
    ...
    for i, bbox in enumerate(bboxes):
        ...
        if( object_to_find == classes[class_ind] ):
            was_found = True
            coords = coor.tolist()
